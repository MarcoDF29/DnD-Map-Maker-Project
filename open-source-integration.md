...
- Treat Creative Commons BY-NC-ND material as reference-only unless the project stays non-commercial and no derivative content is distributed.
...
| --- | --- | --- | --- |
| https://github.com/Azgaar/Fantasy-Map-Generator | MIT license file | World-generation architecture, biome/world data model, routes, settlements, heraldic SVG charges | Reuse ideas and small MIT-compatible modules with attribution. Strong inspiration for separating state, generators, editors, and renderers. |
...
- Copied a curated MIT SVG symbol pack from Azgaar into `assets/azgaar-charges/`.
